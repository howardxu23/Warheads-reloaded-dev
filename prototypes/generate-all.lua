...
local warhead_sanitise = require(warhead_prototype("warhead-sanitise"))
local weapontype_sanitise = require(warhead_prototype("weapontype-sanitise"))
local combine = require(warhead_prototype("warhead-weapontype-combination"))
